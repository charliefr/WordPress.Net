...
using Charlie.Web.WordPress.Data.Sql;
...
namespace Charlie.Web.WordPress
{
    public partial class Startup
    {
        ...
        {
            app.CreatePerOwinContext(new Func<IUserRegisterProvider>(() => new SqlUserRegisterProvider(new SqlDataContext())));
            app.CreatePerOwinContext(new Func<IDataProvider>(() => new SqlDataContext()));
